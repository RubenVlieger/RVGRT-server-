...
class PlayerStateData(BaseModel):
    ...
    transforms: Any = Field(description="Character transform matrices or positional properties")
...
ClientMessage = Annotated[Union[PlayerStateMessage, ChatMessage, BlockUpdateMessage], Field(discriminator="type")]
